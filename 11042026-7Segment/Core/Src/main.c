...
uint8_t sixteen[] = {0xC0+0x0001, 0xF9+0x0002, 0xA4+0x0004, 0xB0+0x0008};
int i = 0;
/* USER CODE END PV */
...
int main(void)
{
  ...
  while (1)
  {
    ...
    HAL_SPI_Transmit(&hspi1, &SEGMENT_MAP[i], 1, 1000);
    HAL_Delay(1);
    HAL_SPI_Transmit(&hspi1, &SEGMENT_SELECT[i], 1, 1000);
    HAL_Delay(100);
